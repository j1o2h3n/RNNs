...
parser.add_argument('--time_length',type=int,default=12,help='Number of time frames')
parser.add_argument('--out_dim',type=int,default=12,help='Output dimension')
parser.add_argument('--batch_size',type=int,default=64,help='batch size')
parser.add_argument('--save',type=str,default='./garage/PEMS08',help='save path')
parser.add_argument('--nhid',type=int,default=64,help='Hidden layer channel dimension')
...
parser.add_argument('--Flag',type=str,default="GRU",help='RNN/LSTM/GRU')
...
def main():
    ...
    print(args)
    engine = trainer(args, scaler, args.Flag, args.input_dim, args.nhid ,args.out_dim, args.time_length)
    ...
    for i in range(1,args.epochs+1):
        ...
        for iter, (x, y) in enumerate(dataloader['train_loader'].get_iterator()):
            ...
            trainx= trainx.transpose(1, 3) # [64, 2, 207, 12]
